...
const AllMovies = () => {
    ...
    // const handleGenreClick = (genreId) => {
    //     console.log("Genre Clicked:", genreId); // Check if the function is called

    //     if (!data) {
    //         console.log("Movies data is undefined!");
    //         return;
    //     }

    //     const filterByGenre = data.filter((movie) => {
    //         console.log("Checking Movie Genre:", movie.genre, "Against Selected Genre:", genreId);
    //         return movie.genre === genreId;
    //     });

    //     console.log("Filtered Movies:", filterByGenre);
    //     dispatch(setFilteredMovies(filterByGenre));
    // };
            ...
            <>
                <section>
                    ...
                    >
                        ...
                        <div className="relative z-10 text-center text-white mt-[3rem]">
                        ...
                        <section className="absolute -bottom-[-6rem]">
                            <input
                                type="text"
                                className="w-[100%] h-[3rem] border px-10 outline-none rounded bg-white"
